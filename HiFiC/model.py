...
class HiFiC(object):
  ...
  def evaluation(self):
    ...
    return self._mode == ModelMode.EVALUATION or self._mode == ModelMode.ATTACK
  ...
  def _get_encoder_out(self,
    ...
    # print("[WARNING] 'Line 558' in model.py: 'encoder_out = self._encoder(input_image_scaled, training=True)' This code is only for attacker.py")
  ...
  def _compute_reconstruction(self, decoder_in, image_shape, output_shape):
    ...
    # print("[WARNING] 'Line 580' in model.py: 'reconstruction_scaled = self._decoder(decoder_in, training=True)' This code is only for attacker.py")
